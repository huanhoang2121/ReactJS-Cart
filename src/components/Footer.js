                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-lg-2 ml-auto">
                            ...
                            <div className="social-section text-md-left">
                                <ul className="text-center">
                                    <li>
                                        <a href="#i" className="btn-floating btn-fb waves-effect waves-light">
                                            <i className="fa fa-facebook"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#i" className="btn-floating btn-ins waves-effect waves-light">
                                            <i className="fa fa-instagram"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#i" className="btn-floating btn-tw waves-effect waves-light">
                                            <i className="fa fa-twitter"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#i" className="btn-floating btn-yt waves-effect waves-light">
                                            <i className="fa fa-youtube"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#i" className="btn-floating btn-li waves-effect waves-light">
                                            <i className="fa fa-linkedin"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#i" className="btn-floating btn-dribbble waves-effect waves-light">
                                            <i className="fa fa-dribbble left"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#i" className="btn-floating btn-pin waves-effect waves-light">
                                            <i className="fa fa-pinterest"></i>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#i" className="btn-floating btn-gplus waves-effect waves-light">
                        ...
                        <div className="col-lg-2">
                            ...
                            <ul>
                                <li>
                                    <a href="#i" >Store Delivery</a>
                                </li>
                                <li>
                                    <a href="#i" >Online Delivery</a>
                                </li>
                                <li>
                                    <a href="#i" >Delivery Terms &amp; Conditions</a>
                                </li>
                                <li>
                                    <a href="#i" >Tracking</a>
                                </li>
                        ...
                        <div className="col-lg-2">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#i" >Return Policy</a>
                                </li>
                                <li>
                                    <a href="#i" >Product Registration</a>
                                </li>
                            </ul>
